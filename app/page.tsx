    ...
    <main className="snap-container">
      ...
      <SectionShell id="links">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.25rem' }}>
          {[
            { href: '/projects', label: 'Projects', desc: 'Selected builds & projects' },
            { href: '/tools', label: 'Tools', desc: 'Dev utilities & tools' },
            { href: '/achievements', label: 'Achievements', desc: 'Hackathons & events' },
            { href: '/certifications', label: 'Certifications', desc: 'Professional credentials' },
          ].map((link) => (
